...
| ID | Décision | Raison |
|---|---|---|
| A1 | Produit isolé : schéma SQL `lab` + routes `/lab/*` | Repo `epitaphe360/Lab`. SQL Lab sur projet Supabase **Laboratoire** `omlhfjfpyttfvntfqjnk`, pas Sib `sbyizudifmqakzxjlndr`. |
